    ...
    <body>
        ...
        <form method="post" action="checkbox.php">
            <p>チェックボックス<br>
                ...
                <input type="checkbox" name="example1-2" value="ノート">ノート
            </p>
            <p>チェックボックス(配列)<br>
                <input type="checkbox" name="example2[]" value="デスクトップ">デスクトップ
                <input type="checkbox" name="example2[]" value="ノート">ノート
            </p>
            <p>チェックボックス(checked属性でノートを選択する)<br>
                <input type="checkbox" name="example3[]" value="デスクトップ">デスクトップ
                <input type="checkbox" name="example2[]" value="ノート" checked>ノート
            </p>
            <p>チェックボックス(disabled属性でボックスを無効化する)<br>
                <input type="checkbox" name="example4[]" value="デスクトップ" disabled>デスクトップ
                <input type="checkbox" name="example4[]" value="ノート" disabled>ノート
            </p>
