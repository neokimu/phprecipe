...
<html lang="ja">
    ...
    <body>
        ...
        // 携帯電話番号のマッチする正規表現です。¥A(090|080|070)は文字列の先頭が090、080、
        // 070のいずれかであることを示します。-?はハイフン1文字だけ、もしくはハイフンなし
        // のどちらかにマッチします。¥d{4}は4文字の数字にマッチします。¥d{4}¥zは文字列の
        // 末尾が4文字数字になっていることを示します。つまり、この正規表現は以下のよう
        // な文字列がマッチします。
        ...
        // を示します。-?はハイフン1文字だけ、もしくはハイフンなしのどどちらかにマッチしま
        // す。\d{4}$は文字列の末尾が4文字の数字になっていることを示します。つまり、この
